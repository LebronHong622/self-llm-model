...
class TestInputEmbeddingLayer:
    ...
    def test_output_shape_basic(self):
        ...
        layer = InputEmbeddingLayer(vocab_size, hidden_size, max_length)
    ...
    def test_output_shape_single_batch(self):
        """测试单个样本的输出形状"""
        vocab_size, hidden_size, max_length = 1000, 512, 256
        layer = InputEmbeddingLayer(vocab_size, hidden_size, max_length)
    ...
    def test_output_shape_large_batch(self):
        """测试大批量的输出形状"""
        vocab_size, hidden_size, max_length = 5000, 1024, 1024
        layer = InputEmbeddingLayer(vocab_size, hidden_size, max_length)
    ...
    def test_output_shape_max_length(self):
        ...
        output = layer(input_ids)
        assert output.shape == (batch_size, max_length, hidden_size)
